      ...
      <body style={{ fontFamily: "'Exo 2', sans-serif" }}>
        <AuthProvider>
          <div className="h-screen w-full bg-[#0f0f0f] overflow-hidden 
              ...
              after:content-[''] after:absolute after:top-0 after:right-0 after:w-[200px] after:h-[200px] after:bg-[url('/iconos-layout.png')] after:bg-no-repeat after:bg-cover after:blur-[0px] fixed top-0 left-0 z-10">
          ...
          <div className="flex w-full">
            {showNavbar && <NavBar />}
            <div className="main-content w-full z-50 relative px-12 mt-16">{children}</div>{" "}
