...
export default function Loading() {
    return (
        <div className="h-screen w-full bg-[#0f0f0f] overflow-hidden 
              ...
              after:content-[''] after:absolute after:bottom-0 after:right-0 after:w-[200px] after:h-[200px] after:bg-[url('/iconos-layout.png')] after:bg-no-repeat after:bg-cover after:opacity-20 after:blur-[2px] z-20 fixed top-0 left-0">
