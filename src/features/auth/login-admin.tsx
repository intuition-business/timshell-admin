            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full">
                ...
                <div className="my-auto -translate-y-[3.125rem]">
                    <div className="text-center">
                        <h2 className="text-[#D4FF00] text-center text-[2rem] leading-[1.1] font-semibold mb-5">Iniciar sesión</h2>
                        <p className="text-white mb-7">Ingresa tu teléfono y correo para recibir tu código de inicio de sesión</p>

                        <input
                            className="bg-[#2B2C2A] text-white border border-white px-6 py-4 rounded-xl w-full max-w-[31.25rem] mb-3"
                            type="email"
                        ...
                        <input
                            className="bg-[#2B2C2A] text-white border border-white px-6 py-4 rounded-xl w-full max-w-[31.25rem]"
                            type="tel"
                        ...
                        <button
                            className={`px-4 py-4 w-full rounded-xl font-semibold mt-7 max-w-[31.25rem] transition-all duration-200 ${isSubmitting ? 'bg-gray-500 cursor-not-allowed' : 'bg-[#D4FF00] hover:bg-[#b9de00] cursor-pointer'
                                }`}
